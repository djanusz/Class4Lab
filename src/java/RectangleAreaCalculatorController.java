...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet RectangleAreaCalculatorController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet RectangleAreaCalculatorController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        } finally {            
//            out.close();
